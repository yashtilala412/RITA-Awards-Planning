async function run() {
    ...
    var mail = components.userLoginFormMobile.data.inp_email.value;
    var pass = components.userLoginFormMobile.data.inp_password.value;
  ...
  if(data.data.length <= 0){
    await components.text22.setText('Email or Password is incorrect');
  }
    ...
    await actions.setVariable('adminStatus',adminStatus);
      ...
      await components.text22.setText('Please cheak your mail verification is incomplete');
  }
  }
